...
Before coding, commit to clear aesthetic direction:
...
- **Typography** - distinctive, characterful fonts. Avoid Inter, Roboto, Arial, system-ui. Pair display font with refined body font.
...
- **Details** - gradient meshes, noise textures, geometric patterns, layered transparencies, grain overlays matching aesthetic.
...
- Do not use generic AI aesthetics: Inter or Roboto, purple gradients, predictable layouts.
- Do not introduce new CSS framework without asking.
- Do not skip accessibility.
- Match implementation complexity to vision: maximalist designs need elaborate code, minimalist designs need restraint.
