...
(def ^:private domain-error-table
  ...
  {:tool-not-found [404 "tool_not_found" (constantly nil)]
   ...
   :active-overlap [409 "active_overlap"]
   :claim-conflict [409 "claim_conflict"]
   :name-conflict [409 "name_conflict"]
   :run-not-active [409 "run_not_active"]
   :job-not-runnable [409 "job_not_runnable"]
