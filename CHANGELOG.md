...
- Wrapped cron completions in a final-only delivery envelope and persisted/sent only its last complete payload, preventing model narration and superseded drafts from leaking into notifications.
