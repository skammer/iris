...
- `/home/example/projects/clj-agent/src/agent/security.clj` - Main security implementation
- `/home/example/projects/clj-agent/log/security-hardening-research.md` - Research documentation
